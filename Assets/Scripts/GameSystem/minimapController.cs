...
public class minimapController
{
    ...
    public static void SetMinimapMaskInPath(FloorManagement floorManagement, float playerX, float playerY)
    {
        ...
        int playerXIndex = Mathf.FloorToInt((playerX + CommonConst.FloorWidth / 2.0f) / CommonConst.FloorWidth);
        int playerYIndex = Mathf.FloorToInt((playerY + CommonConst.FloorHeight / 2.0f) / CommonConst.FloorHeight);
